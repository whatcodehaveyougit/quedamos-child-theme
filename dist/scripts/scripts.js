...
var _countUpJs = require("./js/animations/count-up.js");
var _zoomInJs = require("./js/animations/zoom-in.js");
var _slideUpJs = require("./js/animations/slide-up.js");

},{"./js/general.js":"aoUsD","./js/animations/count-up.js":"2WfzB","./js/animations/zoom-in.js":"3SIcM","./js/animations/slide-up.js":"l7rv1"}],"aoUsD":[function(require,module,exports) {

},{}],"2WfzB":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", ()=>{
    function animateCountUp(elementSelector, targetNumber, duration = 1000) {
        ...
        function checkAndAnimate() {
            if ((0, _commonJs.isInViewport)(element)) {
        ...
        (0, _commonJs.animateOnScrollWithThrottle)([
            element
        ], checkAndAnimate);
    }
...
},{"./common.js":"6Y93F"}],"6Y93F":[function(require,module,exports) {
// Custom throttle function
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "isInViewport", ()=>isInViewport);
parcelHelpers.export(exports, "animateOnScrollWithThrottle", ()=>animateOnScrollWithThrottle);
...
function animateOnScrollWithThrottle(elements, animationFn, delay = 300) {
    let isChecking = false;
    const animationState = new Map(elements.map((element)=>[
            element,
            false
        ]));
    function checkAndAnimate() {
...
},{}],"3SIcM":[function(require,module,exports) {
var _commonJs = require("./common.js");
function addZoomInAnimation(elementSelector) {
    ...
    (0, _commonJs.animateOnScrollWithThrottle)(Array.from(elements), applyZoomIn);
}
...
},{"./common.js":"6Y93F"}],"l7rv1":[function(require,module,exports) {
var _commonJs = require("./common.js");
function addSlideUpAnimation(elementSelector, offset = 100) {
    ...
    function checkIfInViewport(element) {
        return (0, _commonJs.isInViewport)(element, offset);
    }
    // Use animateOnScrollWithThrottle with a function that handles animation
    (0, _commonJs.animateOnScrollWithThrottle)(Array.from(elements), (element)=>{
        if (checkIfInViewport(element)) applySlideUp(element);
...
},{"./common.js":"6Y93F"}]},["5aj6h","5C2sm"], "5C2sm", "parcelRequireac17")
